...
1. Review the `statistical-analysis-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`statistical-analysis-engine.mdc`)
...
- **Technologies:** JavaScript, SQL, TypeScript
...
*For detailed implementation instructions, refer to the `statistical-analysis-engine.mdc` file in this directory.*
