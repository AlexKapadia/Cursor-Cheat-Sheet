...
1. Review the `excel-data-extraction-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`excel-data-extraction-rules.mdc`)
...
*For detailed implementation instructions, refer to the `excel-data-extraction-rules.mdc` file in this directory.*
