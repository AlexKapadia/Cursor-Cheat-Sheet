...
1. Review the `dem-data-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`dem-data-rules.mdc`)
...
- **Technologies:** Git, Python, REST, Redis
...
*For detailed implementation instructions, refer to the `dem-data-rules.mdc` file in this directory.*
