...
1. Review the `vector-math-visual-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`vector-math-visual-engine.mdc`)
...
- **Technologies:** JavaScript, OpenAI, PostgreSQL, REST, SQL, TypeScript
...
- JavaScript, OpenAI, PostgreSQL, REST, SQL, TypeScript
...
*For detailed implementation instructions, refer to the `vector-math-visual-engine.mdc` file in this directory.*
