...
1. Review the `gis-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`gis-rules.mdc`)
...
- **Technologies:** Git, Python, REST, SQL
...
*For detailed implementation instructions, refer to the `gis-rules.mdc` file in this directory.*
