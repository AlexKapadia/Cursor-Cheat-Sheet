...
1. Review the `data-analysis-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`data-analysis-rules.mdc`)
...
*For detailed implementation instructions, refer to the `data-analysis-rules.mdc` file in this directory.*
