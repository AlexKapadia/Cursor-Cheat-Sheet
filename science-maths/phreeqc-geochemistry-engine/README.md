...
1. Review the `phreeqc-geochemistry-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`phreeqc-geochemistry-engine.mdc`)
...
*For detailed implementation instructions, refer to the `phreeqc-geochemistry-engine.mdc` file in this directory.*
