...
1. Review the `code-review-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`code-review-rules.mdc`)
...
*For detailed implementation instructions, refer to the `code-review-rules.mdc` file in this directory.*
