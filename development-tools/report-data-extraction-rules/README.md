...
1. Review the `report-data-extraction-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`report-data-extraction-rules.mdc`)
...
*For detailed implementation instructions, refer to the `report-data-extraction-rules.mdc` file in this directory.*
