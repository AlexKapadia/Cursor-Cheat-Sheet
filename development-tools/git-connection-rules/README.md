...
1. Review the `git-connection-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`git-connection-rules.mdc`)
...
*For detailed implementation instructions, refer to the `git-connection-rules.mdc` file in this directory.*
