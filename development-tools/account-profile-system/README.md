...
1. Review the `account-profile-system.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`account-profile-system.mdc`)
...
- **Technologies:** Git, GitHub, HTML, MongoDB, Next.js, PostgreSQL, React, SQL, Supabase, TypeScript
...
- Git, GitHub, HTML, MongoDB, Next.js, PostgreSQL, React, SQL, Supabase, TypeScript
...
*For detailed implementation instructions, refer to the `account-profile-system.mdc` file in this directory.*
