...
1. Review the `rag-ai-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`rag-ai-engine.mdc`)
...
- **Technologies:** HTML, OpenAI, React, SQL, Supabase, TypeScript
...
- HTML, OpenAI, React, SQL, Supabase, TypeScript
...
*For detailed implementation instructions, refer to the `rag-ai-engine.mdc` file in this directory.*
