...
1. Review the `gemini-ai-integration-guide.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`gemini-ai-integration-guide.mdc`)
...
- **Technologies:** Git, GitHub, HTML, Node.js, Python, REST, TypeScript
...
- Git, GitHub, HTML, Node.js, Python, REST, TypeScript
...
*For detailed implementation instructions, refer to the `gemini-ai-integration-guide.mdc` file in this directory.*
