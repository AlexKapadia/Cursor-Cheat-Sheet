...
1. Review the `machine-learning-models-guide.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`machine-learning-models-guide.mdc`)
...
- **Technologies:** Docker, Git, Python, REST
...
*For detailed implementation instructions, refer to the `machine-learning-models-guide.mdc` file in this directory.*
