...
1. Review the `motion-graphics-library.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`motion-graphics-library.mdc`)
...
- **Technologies:** CSS, HTML, REST, React, TypeScript
...
- CSS, HTML, REST, React, TypeScript
...
*For detailed implementation instructions, refer to the `motion-graphics-library.mdc` file in this directory.*
