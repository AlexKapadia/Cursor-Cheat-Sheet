...
1. Review the `cinematic-angular-smoke.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`cinematic-angular-smoke.mdc`)
...
- **Technologies:** AWS, CSS, HTML, JavaScript, REST, React, Tailwind
...
- AWS, CSS, HTML, JavaScript, REST, React, Tailwind
...
*For detailed implementation instructions, refer to the `cinematic-angular-smoke.mdc` file in this directory.*
