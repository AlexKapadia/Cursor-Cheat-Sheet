# Apple SaaS Suite — Design System & Architecture
...
1. Review the `apple-saas-suite.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`apple-saas-suite.mdc`)
...
- **Technologies:** CSS, JavaScript, React, Tailwind, TypeScript
...
- CSS, JavaScript, React, Tailwind, TypeScript
...
*For detailed implementation instructions, refer to the `apple-saas-suite.mdc` file in this directory.*
