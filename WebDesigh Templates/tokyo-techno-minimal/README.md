...
1. Review the `tokyo-techno-minimal.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`tokyo-techno-minimal.mdc`)
...
- **Technologies:** CSS, Git, HTML, JavaScript, Next.js, React, Tailwind
...
- CSS, Git, HTML, JavaScript, Next.js, React, Tailwind
...
*For detailed implementation instructions, refer to the `tokyo-techno-minimal.mdc` file in this directory.*
