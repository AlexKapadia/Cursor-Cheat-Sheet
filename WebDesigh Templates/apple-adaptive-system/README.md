...
1. Review the `apple-adaptive-system.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`apple-adaptive-system.mdc`)
...
*For detailed implementation instructions, refer to the `apple-adaptive-system.mdc` file in this directory.*
