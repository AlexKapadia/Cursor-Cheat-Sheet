...
1. Review the `interactive-motion.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`interactive-motion.mdc`)
...
- **Technologies:** CSS, HTML, JavaScript, React, Tailwind, TypeScript
...
- CSS, HTML, JavaScript, React, Tailwind, TypeScript
...
*For detailed implementation instructions, refer to the `interactive-motion.mdc` file in this directory.*
