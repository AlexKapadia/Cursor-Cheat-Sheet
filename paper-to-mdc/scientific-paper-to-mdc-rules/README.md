# Scientific Paper to MDC Conversion Rules

## What It Is

This document provides comprehensive guidelines for converting scientific papers (PDFs) about coding techniques and building methods into MDC cheat sheets. These rules ensure complete paper coverage, accurate extraction, and proper file organization. CRITICAL PROTOCOL: When processing a scientific paper, you MUST follow these rules in strict order.
...
1. Review the `scientific-paper-to-mdc-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`scientific-paper-to-mdc-rules.mdc`)
...
*For detailed implementation instructions, refer to the `scientific-paper-to-mdc-rules.mdc` file in this directory.*
