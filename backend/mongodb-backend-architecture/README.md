...
1. Review the `mongodb-backend-architecture.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`mongodb-backend-architecture.mdc`)
...
- **Technologies:** MongoDB, Next.js, Stripe, Supabase, TypeScript
...
- MongoDB, Next.js, Stripe, Supabase, TypeScript
...
*For detailed implementation instructions, refer to the `mongodb-backend-architecture.mdc` file in this directory.*
