...
1. Review the `headless-cms-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`headless-cms-engine.mdc`)
...
- **Technologies:** GraphQL, HTML, Next.js, REST, React, TypeScript
...
- GraphQL, HTML, Next.js, REST, React, TypeScript
...
*For detailed implementation instructions, refer to the `headless-cms-engine.mdc` file in this directory.*
