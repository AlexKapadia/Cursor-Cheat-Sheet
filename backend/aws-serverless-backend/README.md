...
- **Flexible Tenant Isolation:** Enforced at Partition Key level:
- **Organization-owned:** `PK = ORG#<org_id>` (for team SaaS, collaboration tools)

## How to Use It

1. Review the `aws-serverless-backend.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`aws-serverless-backend.mdc`)
...
- **Technologies:** AWS, Git, HTML, Node.js, REST, React, Stripe, TypeScript
...
- AWS, Git, HTML, Node.js, REST, React, Stripe, TypeScript
...
*For detailed implementation instructions, refer to the `aws-serverless-backend.mdc` file in this directory.*
