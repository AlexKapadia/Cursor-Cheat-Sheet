...
1. Review the `etl-pipeline-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`etl-pipeline-engine.mdc`)
...
- **Technologies:** AWS, MongoDB, Node.js, PostgreSQL, Python, Redis, SQL, Stripe, TypeScript
...
- AWS, MongoDB, Node.js, PostgreSQL, Python, Redis, SQL, Stripe, TypeScript
...
*For detailed implementation instructions, refer to the `etl-pipeline-engine.mdc` file in this directory.*
