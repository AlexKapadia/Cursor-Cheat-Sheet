...
1. Review the `supabase-backend-architecture.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`supabase-backend-architecture.mdc`)
...
- **Technologies:** PostgreSQL, React, SQL, Stripe, Supabase, TypeScript
...
- PostgreSQL, React, SQL, Stripe, Supabase, TypeScript
...
*For detailed implementation instructions, refer to the `supabase-backend-architecture.mdc` file in this directory.*
