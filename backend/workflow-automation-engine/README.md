...
1. Review the `workflow-automation-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`workflow-automation-engine.mdc`)
...
- **Technologies:** CSS, Git, GitHub, JavaScript, MongoDB, PostgreSQL, React, Redis, SQL, TypeScript
...
- CSS, Git, GitHub, JavaScript, MongoDB, PostgreSQL, React, Redis, SQL, TypeScript
...
*For detailed implementation instructions, refer to the `workflow-automation-engine.mdc` file in this directory.*
