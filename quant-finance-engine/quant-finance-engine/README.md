...
1. Review the `quant-finance-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`quant-finance-engine.mdc`)
...
- **Technologies:** HTML, JavaScript, Node.js, TypeScript
...
- HTML, JavaScript, Node.js, TypeScript
...
*For detailed implementation instructions, refer to the `quant-finance-engine.mdc` file in this directory.*
