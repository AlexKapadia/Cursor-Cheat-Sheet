...
1. Review the `freelance-bidding-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`freelance-bidding-engine.mdc`)
...
- **Technologies:** AWS, PostgreSQL, REST, SQL, Stripe, Supabase, TypeScript
...
- AWS, PostgreSQL, REST, SQL, Stripe, Supabase, TypeScript
...
*For detailed implementation instructions, refer to the `freelance-bidding-engine.mdc` file in this directory.*
