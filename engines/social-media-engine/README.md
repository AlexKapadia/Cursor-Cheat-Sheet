...
1. Review the `social-media-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`social-media-engine.mdc`)
...
- **Technologies:** HTML, Next.js, PostgreSQL, REST, React, Redis, SQL, Supabase, TypeScript
...
- HTML, Next.js, PostgreSQL, REST, React, Redis, SQL, Supabase, TypeScript
...
*For detailed implementation instructions, refer to the `social-media-engine.mdc` file in this directory.*
