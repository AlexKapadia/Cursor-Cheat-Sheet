...
1. Review the `decision-logic-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`decision-logic-engine.mdc`)
...
- **Technologies:** JavaScript, PostgreSQL, React, SQL, TypeScript
...
- JavaScript, PostgreSQL, React, SQL, TypeScript
...
*For detailed implementation instructions, refer to the `decision-logic-engine.mdc` file in this directory.*
