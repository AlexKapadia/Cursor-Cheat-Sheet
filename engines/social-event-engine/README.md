...
1. Review the `social-event-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`social-event-engine.mdc`)
...
- **Technologies:** CSS, HTML, REST, React, SQL, Stripe, Supabase, TypeScript
...
- CSS, HTML, REST, React, SQL, Stripe, Supabase, TypeScript
...
*For detailed implementation instructions, refer to the `social-event-engine.mdc` file in this directory.*
