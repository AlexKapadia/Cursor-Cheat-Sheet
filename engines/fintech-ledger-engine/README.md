...
1. Review the `fintech-ledger-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`fintech-ledger-engine.mdc`)
...
- **Technologies:** JavaScript, Node.js, PostgreSQL, REST, Redis, SQL, Stripe, TypeScript
...
- JavaScript, Node.js, PostgreSQL, REST, Redis, SQL, Stripe, TypeScript
...
*For detailed implementation instructions, refer to the `fintech-ledger-engine.mdc` file in this directory.*
