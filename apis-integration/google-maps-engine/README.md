...
1. Review the `google-maps-engine.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`google-maps-engine.mdc`)
...
- **Technologies:** HTML, Next.js, REST, React, Tailwind, TypeScript
...
- HTML, Next.js, REST, React, Tailwind, TypeScript
...
*For detailed implementation instructions, refer to the `google-maps-engine.mdc` file in this directory.*
