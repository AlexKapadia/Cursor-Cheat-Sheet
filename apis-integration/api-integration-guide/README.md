...
1. Review the `api-integration-guide.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`api-integration-guide.mdc`)
...
- **Technologies:** AWS, HTML, Node.js, REST, TypeScript, WebSocket
...
- AWS, HTML, Node.js, REST, TypeScript, WebSocket
...
*For detailed implementation instructions, refer to the `api-integration-guide.mdc` file in this directory.*
