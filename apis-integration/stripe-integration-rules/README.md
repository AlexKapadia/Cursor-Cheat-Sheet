...
1. Review the `stripe-integration-rules.mdc` file for detailed architecture and implementation guidelines
...
- **Primary Source:** This MDC file (`stripe-integration-rules.mdc`)
...
- **Technologies:** AWS, Git, JavaScript, Stripe
...
*For detailed implementation instructions, refer to the `stripe-integration-rules.mdc` file in this directory.*
